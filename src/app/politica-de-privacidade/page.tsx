      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#0F2240]">Política de Privacidade</h1>
          </div>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">1. Introdução</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">2. Dados Coletados</h2>
              <h3 className="text-xl font-semibold text-[#0F2240] mb-3">2.1. Dados Fornecidos pelo Usuário</h3>
              ...
              <h3 className="text-xl font-semibold text-[#0F2240] mb-3">2.2. Dados Coletados Automaticamente</h3>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">3. Finalidade do Tratamento</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">4. Compartilhamento de Dados</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">5. Segurança dos Dados</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">6. Direitos do Titular</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">7. Retenção de Dados</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">8. Cookies e Tecnologias Similares</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">9. Alterações nesta Política</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">10. Contato e Encarregado de Dados</h2>
              <p className="text-slate-700 mb-4">
