      ...
      <div className="container mx-auto px-4 py-8 max-w-4xl">
        ...
        <div className="bg-white rounded-lg shadow-lg p-8 md:p-12">
          <div className="flex items-center gap-3 mb-8">
            ...
            <h1 className="text-3xl font-bold text-[#0F2240]">Termos de Uso</h1>
          </div>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">1. Aceitação dos Termos</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">2. Definições</h2>
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">3. Natureza do Serviço</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">4. Uso da Plataforma</h2>
              <h3 className="text-xl font-semibold text-[#0F2240] mb-3">4.1. Requisitos</h3>
              ...
              <h3 className="text-xl font-semibold text-[#0F2240] mb-3">4.2. Condutas Proibidas</h3>
              <ul className="list-disc pl-6 text-slate-700 space-y-2">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">5. Propriedade Intelectual</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">6. Limitação de Responsabilidade</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">7. Modificações dos Termos</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">8. Lei Aplicável e Foro</h2>
              <p className="text-slate-700 mb-4">
            ...
            <section className="mb-8">
              <h2 className="text-2xl font-bold text-[#0F2240] mb-4">9. Contato</h2>
              <p className="text-slate-700 mb-4">
